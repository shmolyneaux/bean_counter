...
class _StatementsScreenState extends State<StatementsScreen> {
  ...
  Widget _buildStatementCard(Statement statement) {
    ...
    final period =
        '${stmtDateFmt.format(statement.statementPeriodStart)} – ${stmtDateFmt.format(statement.statementPeriodEnd)}';
  ...
  Widget _buildSavedLineRow(Statement statement, StatementLine line) {
    ...
    return _SavedLineRow(
      ...
      line: line,
      statement: statement,
      categoryButton: _buildSavedLineCategoryButton(statement, line, effectiveCategoryId),
      ...
      onPickReceipt: () => _pickSavedLineReceipt(statement, line),
    );
  }

  Future<void> _pickSavedLineReceipt(
      Statement statement, StatementLine line) async {
    final picked = await showDialog<String>(
      context: context,
      builder: (_) => ReceiptPickerDialog(
        notifier: widget.notifier,
  ...
  Widget _buildSavedLineCategoryButton(
